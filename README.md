# fullstack-graphql-airbnb

A Fullstack GraphQL Airbnb Clone with React and React Native.

- Branches are in the order they were coded.
- This builds off the GraphQL Typescript Server I made: https://github.com/CodeWhiz44/graphql-ts-server-boilerplate.
...
```
git clone https://github.com/CodeWhiz44/fullstack-graphql-airbnb.git
```

2. cd into folder

```
cd fullstack-graphql-airbnb
```
...
6. [Add a user](https://medium.com/coding-blocks/creating-user-database-and-adding-access-on-postgresql-8bfcd2f4a91e) with the username `postgres` and and no password. (You can change what these values are in the [ormconfig.json](https://github.com/CodeWhiz44/graphql-ts-server-boilerplate/blob/master/ormconfig.json))
...
12. Get Google Maps API key and put it here https://github.com/CodeWhiz44/fullstack-graphql-airbnb/blob/master/packages/web/public/index.html#L14
